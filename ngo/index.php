...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="blog.html">For me</a>
              </li>
              <li class="nav-item">
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/bg.jpeg);">
      <div class="container">
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1>AASHRAY</h1>
              <p>Search for the people who are in need around you.</p>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 element-animate ">
            <a href="medicine.php" class="img-bg" style="background-image: url('images/medicine.jpg')">
              <div class="text">
                <h1 style="color:white">Want to provide?</h1>
                <p>Explore this section</p>
              </div>
            </a>
          </div>
          <div class="col-md-4 element-animate ">
            <a href="doctors.php" class="img-bg" style="background-image: url('images/doctor.jpeg')">
              <div class="text">
                <h1  style="color:white">Want to treat?</h1>
                <p>Explore this section</p>
              </div>
            </a>
          </div>
          <div class="col-md-4 element-animate ">
            <a href="help.php" class="img-bg last" style="background-image: url('images/help.png')">
              <div class="text">
                <h1  style="color:white">Want to help?</h1>
                <p>Explore this section</p>
              </div>
            </a>
          </div>
