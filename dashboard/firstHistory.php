            ...
            <div class="animated fadeIn">
                ...
                <div class="container">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                        <div class="col-lg-2">
                            <input type="checkbox" name="headache" class="form-control">
                            <p style="text-align: center; color: black">Headache</p>
                        </div>
                        <div class="col-lg-2">
                            <input type="checkbox" name="bodyPain" class="form-control">
                            <p style="text-align: center; color: black">Body pain</p>
                        </div>
                        </div><br><br>
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="submit" class="form-control" name="submit" value="Submit" style="background-color: #a324f2; color: white">
                            </div>
                        </div>
                    </form>
                </div>
